...
Version 3 is based on Google's Gemma 2. It is a 9B parameter model, with 200 billion tokens from 11 Southeast Asian languages (English, Chinese, Indonesian, Malay, Thai, Vietnamese, Filipino, Tamil, Burmese, Khmer, and Lao).
