...
| Model                | Download   |
|----------------------|------------|
| Llama-SEA-LION-v3.5-8B-R           | [HuggingFace](https://huggingface.co/aisingapore/Llama-SEA-LION-v3.5-8B-R), [Kaggle]()      |
| Llama-SEA-LION-v3.5-8B-R-GGUF | _coming soon_ |

<br>

## Usage 
Llama-SEA-LION-v3-8B-R can be run using the 🤗 Transformers library 

```python
import transformers
import torch

model_id = "aisingapore/Llama-SEA-LION-v3-8B-R"
